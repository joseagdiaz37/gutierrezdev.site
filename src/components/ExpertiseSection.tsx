      ...
      <div className="container mx-auto px-6">
        ...
        <div className="hidden lg:block max-w-5xl mx-auto mt-8">
          <div className="font-mono text-[10px] text-gray-700 leading-relaxed overflow-hidden opacity-40">
            ...
            <div className="ml-8"><span className="text-cyan-600">&lt;title&gt;</span>What do I do<span className="text-cyan-600">&lt;/title&gt;</span></div>
            <div className="ml-4">&lt;/head&gt;</div>
            <div className="ml-4">&lt;body&gt;</div>
            <div className="ml-8"><span className="text-yellow-600">{"/* Things I do to get a perfect background image */"}</span></div>
            <div className="ml-8"><span className="text-green-600">{"// Maybe I should stop tinkering with VSCode settings"}</span></div>
            <div className="ml-8"><span className="text-green-600">{"// just to take a screenshot of this dummy html code."}</span></div>
            <div className="ml-8"><span className="text-pink-600">{"// Oops, Almost forgot to say 'Hello World'!"}</span></div>
            <div className="ml-4">&lt;/body&gt;</div>
            <div>&lt;/html&gt;</div>
          </div>
        </div>
